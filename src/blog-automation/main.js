...
- 제목, 카테고리, 태그, 키워드 모두 한국어여야 합니다
- 영어나 다른 언어는 절대 사용하지 마세요 (기술용어 제외)
- 영어 주제가 주어져도 반드시 한국어로 번역하여 제목 생성하세요
- 한국 독자가 자연스럽게 검색할 만한 한국어 키워드를 사용하세요
...
🔥 100% 한국어로만 작성 (영어나 다른 언어 절대 금지)
🔥 영어 토픽이어도 반드시 한국어로 번역하여 제목 생성
🔥 한국 독자를 대상으로 한 자연스러운 한국어 표현
🔥 한국어 검색 키워드에 최적화된 제목
🔥 절대로 영어 단어를 포함하지 마세요 (기술용어 제외)
- 주요 타겟 키워드 포함 (한국어로)
- 매력적이고 클릭 유도하는 제목
